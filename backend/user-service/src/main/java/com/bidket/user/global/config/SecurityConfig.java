...
public class SecurityConfig {
     ...
     * - /v1/members/signup, /v1/members/login, /v1/members/token/refresh, /v1/members/check-email, /v1/members/check-nickname 엔드포인트는 인증 없이 접근 가능
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/v1/members/signup", "/v1/members/login", "/v1/members/token/refresh", "/v1/members/check-email", "/v1/members/check-nickname").permitAll()
