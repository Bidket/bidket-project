...
public record SignupRequest(
        ...
        @Schema(description = "마케팅 알림 수신 동의", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
        Boolean marketingAgree,

        /** 이용 약관 동의 여부 (DB 컬럼은 없고 서버에서 검증만 수행) */
        @NotNull(message = "이용 약관 동의 여부는 필수입니다.")
        @Schema(description = "이용 약관 동의", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
