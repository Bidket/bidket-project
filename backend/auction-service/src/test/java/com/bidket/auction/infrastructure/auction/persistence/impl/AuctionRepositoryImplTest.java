...
class AuctionRepositoryImplTest {
    ...
    void setUp() {
        ...
        AuctionStats stats = AuctionStats.builder()
                .totalBidsCount(0)
                .viewCount(0)
                .build();

        WinnerInfo winnerInfo = WinnerInfo.empty();
    ...
    class FindBySellerTest {
        ...
        void findBySellerId_Success() {
            ...
            PriceInfo anotherPriceInfo = PriceInfo.builder()
                    .startPrice(150000L)
                    .currentPrice(150000L)
                    .bidIncrement(5000L)
                    .build();

            AuctionPeriod anotherPeriod = AuctionPeriod.builder()
                    .startTime(LocalDateTime.now().plusHours(3))
                    .endTime(LocalDateTime.now().plusDays(3))
                    .originalEndTime(LocalDateTime.now().plusDays(3))
                    .extensionCount(0)
                    .build();
    ...
    class TimeBasedQueryTest {
        ...
        void findActiveAuctionsEndingBefore_Success() {
            ...
            PriceInfo expiredPriceInfo = PriceInfo.builder()
                    .startPrice(100000L)
                    .currentPrice(100000L)
                    .bidIncrement(5000L)
                    .build();

            AuctionPeriod expiredPeriod = AuctionPeriod.builder()
                    .startTime(pastEndTime.minusDays(1))
                    .endTime(pastEndTime)
                    .originalEndTime(pastEndTime)
                    .extensionCount(0)
                    .build();
        ...
        void findPendingAuctionsStartingBefore_Success() {
            ...
            PriceInfo startPriceInfo = PriceInfo.builder()
                    .startPrice(100000L)
                    .currentPrice(100000L)
                    .bidIncrement(5000L)
                    .build();

            AuctionPeriod startPeriod = AuctionPeriod.builder()
            ...
            Auction shouldStartAuction = Auction.builder()
                    ...
                    .condition(AuctionCondition.NEW)
                    .priceInfo(startPriceInfo)
                    .period(startPeriod)
                    .stats(AuctionStats.createDefault())
                    .winnerInfo(WinnerInfo.empty())
                    .status(AuctionStatus.CREATING)
                    .build();
            shouldStartAuction.confirmCreation(); // CREATING → PENDING
